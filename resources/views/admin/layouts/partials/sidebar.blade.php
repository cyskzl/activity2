        ...
        <div class="side-menu-container">
            <div class="navbar-header" style="background: white;">
                <a class="navbar-brand" href="#">
                    <div class="icon color-white" style="background: white;">
                        <img style="width: 100%;" src="{{asset('admin/img/mycs.png')}}" class="profile-img" alt="">
                    </div>
                    <div class="title" style="color: #333; margin-left: 10px;" title="广东医群科技有限公司">{{str_limit('广东医群科技有限公司', 15)}}</div>
                </a>
